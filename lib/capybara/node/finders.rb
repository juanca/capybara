...
module Capybara
  module Node
    module Finders
      ...
      # @option options [Boolean] allow_reload     When `true` allows elements to be reloaded if they become stale. This is an advanced behavior and should only be used
      #   if you fully understand the potential ramifications. The results can be confusing on dynamic pages.
      ...
      def all(*args, allow_reload: nil, **options, &optional_filter_block)
